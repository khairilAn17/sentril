                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                     ...
                     <!--  <li class="dropdown">
                      ...
                      <li><a href="<?=base_url('penindakan/admin/home/kegiatan')?>"><button class="btn btn-primary"><i class="fa fa-chevron-left"></i> Kembali</button></a> </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">

                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?=base_url('penindakan/admin/home/insert_proccess')?>" id="aas" enctype="multipart/form-data">
