            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=base_url('penindakan/admin/home')?>"><i class="fa fa-home"></i> Home</a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Tambah Kegiatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('penindakan/admin/home/cari_kegiatan')?>">Cari kegiatan</a></li>
                      <li><a href="<?=base_url('penindakan/admin/home/add_kegiatan')?>">Tambah Kegiatan</a></li>
                    </ul>
                  </li>
                 <!--  <li><a><i class="fa fa-desktop"></i> Laporan Kegiatan <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-table"></i> Tabel Kegiatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('penindakan/admin/home/kegiatan')?>">Kegiatan</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Tabel <small>Kegiatan</small></h3>
              </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li>
                          <a href="<?=base_url('penindakan/admin/home/add_kegiatan')?>">
