                  ...
                  <div class="item form-group">
                          ...
                          <button class="btn btn-dark dropdown-toggle" type="button" data-toggle="dropdown">Pilih Tahun Kegiatan
                            <span class="caret"></span></button>
                                ...
                                <?php foreach($tahun as $tahun1){ ?>
                                  <li><a href="<?php echo base_url();?>tu/superuser/home/kurangi_anggaran/<?=$tahun1->tahun?>"><?=$tahun1->tahun?></a></li>
                                  <?php  }?>
                                </ul>
                          </div>
                        </div>
                    ...
                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?=base_url('tu/superuser/home/kurangi_anggaran_proccess')?>" id="aas">
                      <div class="item form-group">
