            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=base_url('tu/superuser/home')?>"><i class="fa fa-home"></i> Home</a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Tambah Kegiatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('tu/superuser/home/add_kegiatan')?>">Tambah Kegiatan</a></li>
                      <li><a href="<?=base_url('tu/superuser/home/cari_kegiatan')?>">Cari Kegiatan</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Laporan Kegiatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('tu/superuser/home/laporan')?>">Laporan</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Tabel Kegiatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>tu/superuser/home/kegiatan/<?= date('Y')?>">Kegiatan</a></li>
                      <li><a href="<?=base_url('tu/superuser/home/log_subkegiatan')?>">Sub Kegiatan</a></li>
                      <li><a href="<?=base_url('tu/superuser/home/tambah_anggaran')?>">Tambah Anggaran</a>
                      </li>
                      <li><a href="<?=base_url('tu/superuser/home/kurangi_anggaran')?>">Kurangi Anggaran</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-users"></i> User <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('tu/superuser/home/user')?>">Data User</a></li>
				<!-- 	  <li><a href="<?=base_url('tu/superuser/home/add_user')?>">Tambah User</a></li> -->
                    </ul>
                  </li>
                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                     ...
                     <!--  <li class="dropdown">
                      ...
                      <li><a href="<?=base_url('tu/superuser/home/kegiatan')?>"><button class="btn btn-primary"><i class="fa fa-chevron-left"></i> Kembali</button></a> </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
