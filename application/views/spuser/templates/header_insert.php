            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=base_url('superuser/home')?>"><i class="fa fa-home"></i> Home</a>
                  </li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Laporan Kegiatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('superuser/home/laporan')?>">Laporan</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Tabel Kegiatan <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a><i class="fa fa-table"></i> Tabel Kegiatan Unit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>superuser/home/kegiatanTu">Bagian TU</a></li>
                      <li><a href="<?=base_url('superuser/home/kegiatanInfokom')?>">Infokom</a></li>
                      <li><a href="<?=base_url('superuser/home/kegiatanPengujian')?>">Pengujian</a></li>
                      <li><a href="<?=base_url('superuser/home/kegiatanPenindakan')?>">Penindakan</a></li>
                      <li><a href="<?=base_url('superuser/home/all_kegiatan')?>">Semua Kegiatan Unit</a></li>
                    </ul>
                  </li>
                   <li><a><i class="fa fa-table"></i> Tabel Sub Kegiatan Unit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>superuser/home/log_subkegiatan_tu">Sub Kegiatan Bagian TU</a></li>
                      <li><a href="<?=base_url('superuser/home/log_subkegiatan_infokom')?>">Sub Kegiatan Infokom</a></li>
                      <li><a href="<?=base_url('superuser/home/log_subkegiatan_pengujian')?>">Sub Kegiatan Pengujian</a></li>
                      <li><a href="<?=base_url('superuser/home/log_subkegiatan_penindakan')?>">Sub Kegiatan Penindakan</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-users"></i> User <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('superuser/home/user')?>">Data User</a></li>
					  <li><a href="<?=base_url('superuser/home/add_user')?>">Tambah User</a></li>
                    </ul>
                  </li>
                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                     ...
                     <!--  <li class="dropdown">
                      ...
                      <li><a href="<?=base_url('superuser/home/kegiatan')?>"><button class="btn btn-primary"><i class="fa fa-chevron-left"></i> Kembali</button></a> </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
