              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Tabel Kegiatan Unit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>superuser/home/kegiatanTu">Kegiatan Bagian TU</a></li>
                      <li><a href="<?=base_url('superuser/home/kegiatanInfokom')?>">Kegiatan Infokom</a></li>
                      <li><a href="<?=base_url('superuser/home/kegiatanPengujian')?>">Kegiatan Pengujian</a></li>
                      <li><a href="<?=base_url('superuser/home/kegiatanPenindakan')?>">Kegiatan Penindakan</a></li>
