                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li>
                          <a href="<?=base_url('superuser/home/user')?>">
                  ...
                  <div class="x_content">
                  <form class="form-horizontal form-label-left" novalidate method="post" action="<?=base_url('superuser/home/insert_proccess_user')?>" id="aas">
