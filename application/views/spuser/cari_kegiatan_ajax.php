 <div class="x_content">
  <table>
      <tr>
        <td><b>Nama Kegiatan</b> &nbsp</td>
        <td> : </td>
        <td><b>&nbsp <?php echo $nama['nama_kegiatan'];?></b></td>
      </tr>          
      <tr>
    ...
    <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
      ...
      <tbody>
       ...
       <?php $i=1; foreach ($row as $rows) {?>
          <tr>
            <td><?=$i++;?></td>
            <td><?=$rows['tanggal_kegiatan']; echo " "; echo $rows['tahun'];?></td>
  ...
  <!--         </form> -->
    <a href="<?=base_url('superuser/home/print_laporan_sub?id=')?><?php echo $rows['id_kegiatan'];?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export</a>
     <a href="<?=base_url('superuser/home/cetak_pdf_sub?id=')?><?php echo $rows['id_kegiatan'];?>" target="blank" class="btn btn-danger"><i class="fa fa fa-file-pdf-o"></i> Pdf</a>
  </div>