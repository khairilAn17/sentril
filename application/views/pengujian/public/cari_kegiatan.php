              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                     ...
                     <!--  <li class="dropdown">
                      ...
                      <li><a href="<?=base_url('pengujian/petugas/home/kegiatan')?>"><button class="btn btn-primary"><i class="fa fa-chevron-left"></i> Kembali</button></a> </li>
                    </ul>
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left" id="form_ini" novalidate method="post" action="<?=base_url('pengujian/petugas/home/proses_cari')?>">
