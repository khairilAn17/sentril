             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="x_content">
                    ...
                    <form method="post" action="<?=base_url('pengujian/superuser/home/delete_subkegiatan')?>">
                          ...
                          <tr>
                            ...
                            <td>
                              <?php if($rows['status']=='belum verifikasi'){?>
                                <a href="<?=base_url().'pengujian/superuser/home/verifikasi?id='?><?php echo $rows['id_subkegiatan'];?>&&id_keg=<?php echo $rows['id_kegiatan'];?>" onclick="return confirm('yakin ingin verifikasi?')" class="btn btn-primary"><i class="fa fa-file-text"></i></a>
                              <?php }else{?>
                                verified
                              <?php }?>
