              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Tabel Kegiatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>pengujian/superuser/home/kegiatan/<?= date('Y')?>">Kegiatan</a></li>
                      <li><a href="<?=base_url('pengujian/superuser/home/log_subkegiatan')?>">Sub Kegiatan</a></li>
                      <li><a href="<?=base_url('pengujian/superuser/home/tambah_anggaran')?>">Tambah Anggaran</a></li>
