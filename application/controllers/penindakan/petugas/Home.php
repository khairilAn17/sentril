...
class Home extends CI_Controller {
	...
	{
		$this->load->view('penindakan/public/templates/header_home');
		$this->load->view('penindakan/public/home');
		$this->load->view('penindakan/public/templates/footer_home');
	}
    ...
    $this->session->set_flashdata('tahun', '2019');
		//var_dump($data);die;
		$this->load->view('penindakan/public/templates/header_table');
		$this->load->view('penindakan/public/kegiatan',$data);
		$this->load->view('penindakan/public/templates/footer_table');
	}

	public function cari_kegiatan(){
		//$data['row'] = $this->penindakan_model->get_all_data("tbl_kegiatan_penindakan")->result_array();
		//var_dump($data);die;
		$this->load->view('penindakan/public/templates/header_insert');
		$this->load->view('penindakan/public/cari_kegiatan');
		$this->load->view('penindakan/public/templates/footer_insert');
		$this->load->view('penindakan/public/cari_kegiatan_script');
	}
	...
	function cari_kegiatan_ajax($id){
		...
		$this->load->view('penindakan/public/cari_kegiatan_ajax',$data);
	}
 ...
 //        $detail = $this->penindakan_model->get_all_data("tbl_kegiatan_penindakan")->result_array();
 //    $total = $this->penindakan_model->get_total_kegiatan()->row_array();
 //    $subtotal = $this->penindakan_model->get_total_subkegiatan()->row_array();
 ...
 //  }
  ...
  // function cetak_pdf(){
  //   $data['row'] = $this->penindakan_model->get_all_data("tbl_kegiatan_penindakan")->result_array();
  //   $data['total'] = $this->penindakan_model->get_total_kegiatan()->row_array();
  //   $data['subtotal'] = $this->penindakan_model->get_total_subkegiatan()->row_array();
