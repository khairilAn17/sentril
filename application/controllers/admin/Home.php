...
class Home extends CI_Controller {
	...
	public function insert_proccess(){
		...
		$id_subkegiatan = $this->sentril_model->get_id_subkegiatan('tbl_subkegiatan', $id, $jam, $ket, $tgl);
		...
		$this->sentril_model->insert_data("tbl_subangaran_all",$data1);		
 ...
 //        $detail = $this->sentril_model->get_all_data("tbl_kegiatan", "tanggal", 2019)->result_array();
