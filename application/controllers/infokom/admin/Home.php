...
class Home extends CI_Controller {
	...
	{
		$this->load->view('infokom/private/templates/header_home');
		$this->load->view('infokom/private/home');
		$this->load->view('infokom/private/templates/footer_home');
	}
	...
	public function kegiatan()
	{
		...
		$this->load->view('infokom/private/templates/footer_table');
	}
	...
	public function add_kegiatan(){
		...
		$this->load->view('infokom/private/templates/footer_insert');
	}
	...
	public function cari_kegiatan(){
		...
		//var_dump($data);die;
		$this->load->view('infokom/private/templates/header_insert');
		$this->load->view('infokom/private/cari_kegiatan');
		$this->load->view('infokom/private/templates/footer_insert');
		$this->load->view('infokom/private/cari_kegiatan_script');
	}
	public function insert_proccess(){
		...
		//var_dump($data);die;
		$this->infokom_model->insert_data("tbl_subkegiatan_infokom",$data);
		$id_subkegiatan = $this->infokom_model->get_id_subkegiatan('tbl_subkegiatan_infokom', $id, $jam, $ket, $tgl);
		...
		$this->infokom_model->insert_data("tbl_subangaran_all",$data1);		
		redirect('infokom/admin/home/kegiatan');
	}
	...
	function cari_kegiatan_ajax($id){
		...
		$this->load->view('infokom/private/cari_kegiatan_ajax',$data);
	}
 ...
 //        $detail = $this->infokom_model->get_all_data("tbl_kegiatan_infokom", "tanggal", 2019)->result_array();
