...
class Home extends CI_Controller {
	...
	{
		$this->load->view('tu/private/templates/header_home');
		$this->load->view('tu/private/home');
		$this->load->view('tu/private/templates/footer_home');
	}
	...
	public function kegiatan()
	{
		...
		//var_dump($data);die;
		$this->load->view('tu/private/templates/header_table');
		$this->load->view('tu/private/kegiatan',$data);
		$this->load->view('tu/private/templates/footer_table');
	}

	public function add_kegiatan(){
		$data['row'] = $this->tu_model->get_all_data("tbl_kegiatan_tu", "tanggal", 2019)->result_array();
		//var_dump($data);die;
		$this->load->view('tu/private/templates/header_insert');
		$this->load->view('tu/private/add_kegiatan',$data);
		$this->load->view('tu/private/templates/footer_insert');
	}
	...
	public function cari_kegiatan(){
		...
		//var_dump($data);die;
		$this->load->view('tu/private/templates/header_insert');
		$this->load->view('tu/private/cari_kegiatan');
		$this->load->view('tu/private/templates/footer_insert');
		$this->load->view('tu/private/cari_kegiatan_script');
	}
	public function insert_proccess(){
		...
		//var_dump($data);die;
		$this->tu_model->insert_data("tbl_subkegiatan_tu",$data);
		$id_subkegiatan = $this->tu_model->get_id_subkegiatan('tbl_subkegiatan_tu', $id, $jam, $ket, $tgl);
		...
		$this->tu_model->insert_data("tbl_subangaran_all",$data1);
		redirect('tu/admin/home/kegiatan');
	}
	...
	function cari_kegiatan_ajax($id){
		...
		$this->load->view('tu/private/cari_kegiatan_ajax',$data);
	}
 ...
 //        $detail = $this->tu_model->get_all_data("tbl_kegiatan_tu", "tanggal", 2019)->result_array();
