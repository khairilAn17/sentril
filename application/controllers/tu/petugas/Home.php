...
class Home extends CI_Controller {
	...
	{
		$this->load->view('tu/public/templates/header_home');
		$this->load->view('tu/public/home');
    ...
    $this->session->set_flashdata('tahun', $tahun);
		...
		$this->load->view('tu/public/templates/footer_table');
	}

	public function cari_kegiatan(){
		//$data['row'] = $this->tu_model->get_all_data("tbl_kegiatan_tu")->result_array();
		//var_dump($data);die;
		$this->load->view('tu/public/templates/header_insert');
		$this->load->view('tu/public/cari_kegiatan');
		$this->load->view('tu/public/templates/footer_insert');
		$this->load->view('tu/public/cari_kegiatan_script');
	}
  ...
  // function cetak_pdf(){
  //   $data['row'] = $this->tu_model->get_all_data("tbl_kegiatan_tu")->result_array();
  //   $data['total'] = $this->tu_model->get_total_kegiatan()->row_array();
  //   $data['subtotal'] = $this->tu_model->get_total_subkegiatan()->row_array();
